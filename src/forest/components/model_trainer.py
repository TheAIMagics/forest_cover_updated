...
from src.forest.configuration.s3_operations import S3Operation
    ...
    def initiate_model_trainer(self, train_set: DataFrame, test_set: DataFrame) -> None:
        ...
        try:
            ...
            if best_model_score >= base_model_score:
                ...
                heartstroke_model = HeartStrokeModel(preprocessing_obj, best_model)

                logging.info(
                    "Created Heart Stroke object with preprocessor and model"
                )

                logging.info("Created best model file path.")

                self.utils.save_object(BEST_MODEL_PATH, heartstroke_model)
